                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="mt-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1 text-sm text-gray-500 hover:text-blue-600 rounded px-1.5 py-0.5 transition-colors disabled:cursor-not-allowed disabled:hover:text-gray-500"
                    >
                      <svg
