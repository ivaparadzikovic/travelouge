          ...
          return (
            <li key={d.country_id}>
              <Link
                ...
                className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white py-1.5 pl-1.5 pr-3 text-sm transition hover:border-teal-400 hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:hover:border-teal-500 dark:hover:bg-gray-700"
              >
                <img
